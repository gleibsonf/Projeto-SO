...
public class Produto {
	    ...
	    protected String categoriaProduto;
	     ...
	     Produto(Fornecedor fornecedor, Produto produto, Produto p0,  Produto p2, Produto p3, Produto p4, Fornecedor f0, Fornecedor f1,
	    ...
	    Produto(int CodProduto, String nomeProduto, String marcaProduto, double valorProduto, int quantidadeProduto){
